...
let line2 = document.querySelector('.staticPlaneP2Lose');
let line3 = document.querySelector('.staticPlaneP3Lose');
...
function lowerVolume(){
    volume *= .59; // use * for gradual change without sudden stop of music
